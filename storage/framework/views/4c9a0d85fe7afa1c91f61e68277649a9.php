...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="relative bg-white p-6 rounded-xl shadow-md overflow-hidden">
        ...
        <p class="text-xs text-gray-400 mt-1">Keseluruhan sampah hari ini</p>
    </div>
...
<?php /**PATH /home/hanif/Documents/Laravel/smart_scale_project/resources/views/components/cards-stats.blade.php ENDPATH**/ ?>