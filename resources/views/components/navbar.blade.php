    ...
    <nav class="-mb-px flex flex-wrap justify-center sm:justify-start space-x-4 sm:space-x-8" aria-label="Tabs">
        ...
        <a href="#"
            class="group inline-flex items-center px-1 py-4 border-b-2 text-sm font-medium
                   ...
                   hover:text-teal-700 hover:border-teal-600
                   transition-colors duration-200 ease-in-out">
            {{-- Icon: Home/Overview --}}
            <svg class="mr-2 h-5 w-5 text-teal-500 group-hover:text-teal-600 transition-colors duration-200 ease-in-out" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="/fakultas"
            ...
            <svg class="mr-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 transition-colors duration-200 ease-in-out" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
