        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="relative bg-white p-6 rounded-xl shadow-md overflow-hidden">
                ...
                <div class="absolute top-0 left-0 w-full h-1.5"
                    style="background-color: #447F40; border-top-left-radius: 0.75rem; border-top-right-radius: 0.75rem;">
                </div>
            ...
            <div class="relative bg-white p-6 rounded-xl shadow-md overflow-hidden">
                ...
                <div class="absolute top-0 left-0 w-full h-1.5"
                    style="background-color: #62B682; border-top-left-radius: 0.75rem; border-top-right-radius: 0.75rem;">
                </div>
            ...
            <div class="relative bg-white p-6 rounded-xl shadow-md overflow-hidden">
                ...
                <div class="absolute top-0 left-0 w-full h-1.5"
                    style="background-color: #5C7AF3; border-top-left-radius: 0.75rem; border-top-right-radius: 0.75rem;">
                </div>
            ...
            <div class="relative bg-white p-6 rounded-xl shadow-md overflow-hidden">
                ...
                <div class="absolute top-0 left-0 w-full h-1.5"
                    style="background-color: #D35748; border-top-left-radius: 0.75rem; border-top-right-radius: 0.75rem;">
                </div>
